...
public class SplitWorkingPanel extends sngforge.panther.modules.WorkingPanel{

    SplitWorkingPanel aewp=(SplitWorkingPanel)Globals.wp;
    SwingWorker sw;
    /** Creates new form SplitWorkingPanel */
    public SplitWorkingPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Splitting file:");
    ...
    public void process(){
        ...
        Globals.tmp=new JScrollPane(Globals.rp);
                ...
                protected Object doInBackground(){
                    SplitEntry ee=(SplitEntry)Globals.ee;
                    Encoder e=new Encoder();
                    float sec;
                    try{
                        currFile.setText(ee.inFile.getName());
                        MultimediaInfo mi=e.getInfo(ee.inFile);
                        String format=mi.getFormat();
                        sec=(float) (mi.getDuration()/1000.0);
                        ...
                        for(int i=0;i<ee.timepoints.size();i++){
                            ...
                            ea.setFormat(format);
                            ea.setOffset(offset);
                            ea.setDuration((Float)ee.timepoints.get(i));
                            EncoderListener ael=new EncoderListener();
                            ael.setParent(aewp);
                            e.encode(ee.inFile, new File(sb.toString()), ea, ael);
